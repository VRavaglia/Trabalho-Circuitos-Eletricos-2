...
// Retire o comentario para observar a montagem de estampas
//#define DEBUG
...
int main(int argc, char* argv[])
{
 ...
 denovo:
  ...
  // -----------  ROTINA QUE LÊ O NETLIST E GERA OS NETLISTS INTERNOS -
  ...
  for (i=1; i<=nv; i++) {
    ...
    // Aproveitando codigo para escrever o arquivo de solução
    outputFile << txt <<" "<< lista[i]<<" : " << Yn[i][nv+1] << std::endl;
  }
    // Fechando o arquivo;
    outputFile.close();
  //getchar();
